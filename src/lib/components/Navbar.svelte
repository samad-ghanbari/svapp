...
<Navbar>
	<NavBrand href="/">
		<img src="/assets/images/logo/logo512.png" class="me-3 h-6 sm:h-9" alt="Flowbite Logo" />
		<span class="font-phamelo self-center text-xl font-semibold whitespace-nowrap dark:text-white"
			>iSchool</span
		>
	</NavBrand>
	<NavHamburger />
